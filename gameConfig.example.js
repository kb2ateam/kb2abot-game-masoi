...
const data = { // Data về các role (khi nhắn "help")
	BaoVe: {
...
const code = { // developer only (cái này chỉ là phân loại th, ko nên chỉnh)
	"VOTEKILL": 0,
	"BAOVE": 1,
	"SOITHUONG": 2,
	"TIENTRI": 3,
